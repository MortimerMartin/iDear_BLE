...
//  SuperWatch
//
//  Created by Mortimer on 17/3/21.
...
@interface SportVC ()<UITableViewDelegate,UITableViewDataSource>
...
static NSString * kDeleteHistoryCell = @"DeleteHistoryCell";
...
- (void)setupTableView{
    ...
    [_tableView registerClass:[DeleteHistoryCell  class] forCellReuseIdentifier:kDeleteHistoryCell];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    DeleteHistoryCell * cell = [tableView dequeueReusableCellWithIdentifier:kDeleteHistoryCell];
    if (!cell) {
        cell = [tableView dequeueReusableCellWithIdentifier:kDeleteHistoryCell forIndexPath:indexPath];
    }
