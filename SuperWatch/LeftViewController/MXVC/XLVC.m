...
@interface XLVC ()<UITableViewDelegate,UITableViewDataSource>
...
static NSString * XLVCCell = @"XLVCCell";
...
- (void)setupTableView{
    ...
    [_tableView registerClass:[PersonHistoryCell  class] forCellReuseIdentifier:XLVCCell];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    PersonHistoryCell * cell = [tableView dequeueReusableCellWithIdentifier:XLVCCell];
    if (!cell) {
        cell = [tableView dequeueReusableCellWithIdentifier:XLVCCell forIndexPath:indexPath];
    }
...
//    self.navigationController.title = @"心率明细";
    self.title = @"心率明细";
